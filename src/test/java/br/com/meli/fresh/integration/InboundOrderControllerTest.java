...
public class InboundOrderControllerTest {
    ...
    public InboundOrderRequest getValidRequestInstance(){
        ...
        Product product1 = new Product(null, "Bolacha Trakinas", "fresco", 5F, 30F, 0.25F, null);
        product1 = productRepository.save(product1);

        Product product2 = new Product(null, "Batata Doce", "fresco", 10F, 30F, 1F, null);
    ...
    public InboundOrderRequest getInstanceWithInvalidProductType(){
        ...
        // Invalid product
        Product product1 = new Product(null, "Pizza Quatro Queijos", "congelado", 5F, 30F, 0.25F, null);
        product1 = productRepository.save(product1);
    ...
    public InboundOrderRequest getInstanceWithInvalidVolume(){
        ...
        Product product1 = new Product(null, "Pizza Quatro Queijos", "congelado", -10F, 30F, 1F, null);
        product1 = productRepository.save(product1);

        Product product2 = new Product(null, "Pao de Queijo", "congelado", -30F, 30F, 1F, null);
        product2 = productRepository.save(product2);
    ...
    public void testInvalidSectionTypeException() throws Exception {
        ...
        assertEquals(errorDTO.getError(), "InvalidSectionTypeException");
    }
    ...
    public void testInsufficientAvailableSpaceException() throws Exception {
        ...
        assertEquals(errorDTO.getError(), "InsufficientAvailableSpaceException");
    }
